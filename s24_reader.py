...
FORM, LEMMA, UPOS, FEATS, ID, HEAD, DEPREL, MISC, _, SKEIDA, PASKA = range(11) # corresponding UD columns
...
def read_s24(f):
    ...
    for line in f:
        ...
        cols = line.split("\t")
        if len(cols) != 11:
            print("Weird line, skipping...", line, len(cols), file=sys.stderr)
            continue
...
def main(args):
    ...
    counter = 0
    #fname = fnames[3]
    fname = 'suomi24-2001-2017-vrt-v1-1/vrt/s24_2001.vrt'
...
if __name__=="__main__":
    ...
    argparser.add_argument('--zipfile', default="suomi24-2001-2017-vrt-v1-1.zip", help='zipfile downloaded from kielipankki')
    ...
    #            for m in meta:
    #                print("###C:", m)
    #            print(fix_encoding(text).encode("utf-8"))
    #            print("")
